...
<center>
    <header class="cabecalho">
        ...
        <br>
        <h2 class="titulo" align="center">CADASTRO DE USUÁRIOS </h2>
    ...
    <a href="usu_alt_cons.php"><button style="background: #069cc2; border-radius: 6px; padding: 10px; cursor: pointer; color: #fff; border: none; font-size: 10px;">ATUALIZAR </button></a>
...
<a href="../index.php"> <img src="../img/retornar.png" width="20" height="20">  </a>
